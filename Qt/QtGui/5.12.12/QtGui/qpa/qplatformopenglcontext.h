...
public:
    ...
    virtual void updateDamageRegion(QPlatformSurface *surface, QList<QRectF> damageRects) = 0;
#else
    virtual void updateDamageRegion(QPlatformSurface *surface, QRectF damageRects) = 0;
#endif
#endif
